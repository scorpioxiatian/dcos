...
<div class="body">
 <div>当前位置：<a href="#">资源管理<a/>>></a><a href="#">物理机资源</a><hr width="630px" align="left"></div>
 <div><img src="img/jt.jpg" width="20" height="20">      <a href="#">新建虚拟机</a></div>
 <div class="table"><h3>节点信息</h3>
 <table width="630" height="50" border="0" >
	  <tr bgcolor="#578DCE">
	    <th scope="col"><b>分区</b></th>
	    <th scope="col"><b>物理机IP</b></th>
	    <th scope="col"><b>操作</b></th>
	    <th scope="col"><b>剩余CPU</b></th>
	    <th scope="col"><b>剩余内存</b></th>
	  </tr>
	<c:if test="${!empty listPM }">
		<c:forEach items="${listPM }" var="pm">
			<tr>
				<td align="center">PMCluster01</td>
				<td align="center">${pm.pm_ip }</td>
				<td align="center">
					<a href="#">关机</a>
					<a href="#">重启</a>
				</td>
				<td align="center">${pm.disk_size - pm.disk_used }</td>
				<td align="center">${pm.mem_size - pm.mem_used }</td>
			</tr>				
		</c:forEach>
	</c:if>
</table>
<table>
		<tr>
			...
			<td><a href="getSourcePM?size=10&pageno=1">首页</a></td>
			<td><a href="getSourcePM?size=10&pageno=${ pageno-1}"+>上一页</a></td>
			<td><a href="getSourcePM?size=10&pageno=${pageno+1 }"+>下一页</a></td>
			<td><a href="getSourcePM?size=10&pageno=${totalPageNo }"+>尾页</a></td>
