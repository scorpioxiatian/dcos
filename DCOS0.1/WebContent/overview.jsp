...
.body .buttom1{width:100px; margin:140px 0px 0px 530px; position:absolute;}
.body .buttom1 a{ text-height:auto; text-align:right}
.body .buttom2{width:100px; margin:300px 0px 0px 530px; position:absolute;}
.body .buttom2 a{ text-height:auto; text-align:right}
.body .buttom3{width:100px; margin:460px 0px 0px 530px; position:absolute;}
.body .buttom3 a{ text-height:auto; text-align:right}
.body .buttom4{width:100px; margin:615px 0px 0px 530px; position:absolute;}
.body .buttom4 a{ text-height:auto; text-align:right}
.left{ position: relative; margin: 20px 20px 0px 0px;  }
.left a{ font-size:24px; font-weight:bold; color:#00F; text-height:auto; text-align:center; }
b{
	font-size: 13px;
	font-weight: 100;
	text-align: center;
...
<div class="body">
<div>当前位置：全局视图<hr width="630px" align="left"></div>
<div class="table1">主机全局概况
<table width="631"  border="0">
  <tr bgcolor="#578DCE" >
    <td width="100"align="center"><b>主机名</b></td>
    <td width="94"align="center"><b>主机IP</b></td>

    <td width="98"align="center"><b>核数</b></td>
    <td width="114"align="center"><b>已使用核数</b></td>
  </tr>
...
<div class="buttom1"><a href="get_pm_view?size=10&pageno=1" ><img src="img/more.jpg" width="97" height="19" alt="more" /></a></div>
<div class="table2">虚拟机概况
<table width="631" height="60"  border="0" >
  <tr bgcolor="#578DCE">
    <th width="90" scope="col"><b>节点主机名</b></th>
    <th width="68" scope="col"><b>虚拟机CPU</b></th>
    <th width="79" scope="col"><b>虚拟机内存</b></th>

    <th width="72" scope="col"><b>虚拟机状态</b></th>
    <th width="60" scope="col"><b>用户id</b></th>
    <th width="90" scope="col"><b>虚拟机主机名</b></th>
  </tr>
  <c:if test="${!empty vmList }">
				<c:forEach items="${vmList }" var="vm">
					<tr>
						<td align="center">${vm.pm.pm_name }</td>
						<td align="center">${vm.vm_cpu }</td>
						<td align="center">${vm.vm_mem }</td>

						<td align="center">${vm.vm_state }</td>
						<td align="center">${vm.uid }</td>
						<td align="center">${vm.vm_hostname }</td>
					</tr>
				</c:forEach>
			</c:if>
</table>
</div>
<div class="buttom2"><a href="get_vm_view?size=10&pageno=1"><img src="img/more.jpg" width="97" height="19" alt="more" /></a></div>

<div class="table3">应用概况
<table width="631" border="0" >
  <tr bgcolor="#578DCE">
	<!-- <th width="68" scope="col"><b>序号</b> -->
    <th width="68" scope="col"><b>Nutch主机</b></th>
    <th width="79" scope="col"><b>Nutch时间</b></th>
    <th width="82" scope="col"><b>Tomcat主机</b></th>
    <th width="69" scope="col"><b>Tomcat总时间</b></th>
...
<script type="text/javascript">
  ...
  <c:if test="${!empty nutchList }">
				<c:forEach items="${nutchList }" var="nutch">
					<c:forEach items="${tomcatList}" var="tomcat" begin="${j}" end="${j}" >
					<tr>
						...
						<%-- <td><c:out value="${i}"/></td> --%>
						<td align="center">${nutch.slave.vm_hostname }</td>
						<td align="center">${nutch.nutch_resp_time }</td>
						<td align="center">${tomcat.tomcat_hostname }</td>
						<td align="center">${tomcat.response_time }</td>
...
<div class="buttom3">
	<a href="get_nutch_view?size=10&pageno=1"><img src="img/more.jpg" width="97" height="19" alt="more" /></a>
</div>
<div class="table4">分析概况
<table width="631" border="0" >
  <tr bgcolor="#578DCE">

    <th width="68" scope="col"><b>Master</b></th>
    <th width="79" scope="col"><b>Slave</b></th>
  </tr>
  <c:if test="${!empty batchList }">
				<c:forEach items="${batchList }" var="batch">
					<tr>
						<td align="center">${batch.master.vm_hostname }</td>
						<td align="center">${batch.slave.vm_hostname }</td>
...
<div class="buttom4">
	<a href="get_batch_view?size=10&pageno=1"><img src="img/more.jpg" width="97" height="19" alt="more" /></a>
</div>
