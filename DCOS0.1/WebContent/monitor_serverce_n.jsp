...
<body>
	...
	<div class="ground">
		...
		<div class="body">
			<div>
				当前位置：<a href="#">监控<a />>><a href="#">应用监控</a>>>搜索引擎
			...
			<div class="table">
				...
				<table width="613" height="74" border="0">
					<tr bgcolor="#578DCE">
						<th width="119" scope="col"><b>服务器名</b></th>
						<th width="119" scope="col"><b>服务器ID</b></th>
						<th width="137" scope="col"><b>响应时间</b></th>
						<th width="97" scope="col"><b>--</b></th>
						<th width="119" scope="col"><b>--</b></th>
					</tr>
					<tr>
						<td>&nbsp;</td>
						<td>&nbsp;</td>
