...
<div class="body">
<div>当前位置：<a href="getOverview">全局视图</a>>虚拟机概况<hr width="631px" align="left"></div>
<div class="table1">
<table width="631"height="50" border="0" >
  <tr bgcolor="#578DCE">
    <th width="80" scope="col"><b>节点主机名</b></th>
    ...
    <th width="80" scope="col"><b>虚拟机主机名</b></th>
  </tr>
...
<table>
		<tr>
			...
			<td><a href="get_vm_view?size=10&pageno=1">首页</a></td>
			<td><a href="get_vm_view?size=10&pageno=${ pageno-1}"+>上一页</a></td>
			<td><a href="get_vm_view?size=10&pageno=${pageno+1 }"+>下一页</a></td>
			<td><a href="get_vm_view?size=10&pageno=${totalPageNo }"+>尾页</a></td>
