...
.sidebar{min-height: 700px; position:relative; z-index: 10; left: 0px; top: 5px; width: 150px; height:100%; padding: 0px 20px 0px 10px; background-color:#B3E0E6;float:right;}
...
<div class="body">
 <div>当前位置：<a href="#">监控<a/>>>dcos监控
   <hr width="593px" align="left"></div>
 <div class="table">
 <h3>物理机信息</h3>
 <table width="598" height="74" border="0" >
  <tr bgcolor="#578DCE">
    <th width="120" scope="col"><b>主机名</b></th>
    <th width="120" scope="col"><b>内存大小</b></th>
    <th width="138" scope="col"><b>内存使用率</b></th>
    <th width="120" scope="col"><b>CPU使用率</b></th>
    <th width="120" scope="col"><b>硬盘大小</b></th>
    <th width="120" scope="col"><b>核数</b></th>
    <th width="120" scope="col"><b>虚拟机数量</b></th>
  </tr>
  <tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
 ...
 <div class="table"><table width="624" border="0">
  <tr>
    <td width="160">虚拟机名</td>
    <td width="109">&nbsp;</td>
    <td width="118">&nbsp;</td>
    <td width="86">&nbsp;</td>
    <td width="129">&nbsp;</td>
